...
//  MACAddr[0] = 0x00;
//  MACAddr[1] = 0x80;
//  MACAddr[2] = 0xE9;//0xE2;//0xE1;  // TODO Add based on Device ID of Microcontroller
//  MACAddr[3] = 0x00;
//  MACAddr[4] = 0x00;
//  MACAddr[5] = 0x00;

  MACAddr[0] = 0x02;  //0000 0010 1st bit set to 1 means LAA MAC address
  MACAddr[1] = 0x80;
  MACAddr[2] = (unsigned char)(STM32_CRC32 & 0xff);
  MACAddr[3] = (unsigned char)(STM32_CRC32 >> 8) & 0xff;
  MACAddr[4] = (unsigned char)(STM32_CRC32 >> 16) & 0xff;
  MACAddr[5] = (unsigned char)(STM32_CRC32 >> 24);

  ethernetMac[0] = 0x02;  //0000 0010 1st bit set to 1 means LAA MAC address
  ethernetMac[1] = 0x80;
  ethernetMac[2] = (unsigned char)(STM32_CRC32 & 0xff);
  ethernetMac[3] = (unsigned char)(STM32_CRC32 >> 8) & 0xff;
  ethernetMac[4] = (unsigned char)(STM32_CRC32 >> 16) & 0xff;
  ethernetMac[5] = (unsigned char)(STM32_CRC32 >> 24);

  gFinalAnaValF[ETHERNET_MAC_0_gFinalAnaValF] = MACAddr[0];
  gFinalAnaValF[ETHERNET_MAC_1_gFinalAnaValF] = MACAddr[1];
  gFinalAnaValF[ETHERNET_MAC_2_gFinalAnaValF] = MACAddr[2];
  gFinalAnaValF[ETHERNET_MAC_3_gFinalAnaValF] = MACAddr[3];
  gFinalAnaValF[ETHERNET_MAC_4_gFinalAnaValF] = MACAddr[4];
  gFinalAnaValF[ETHERNET_MAC_5_gFinalAnaValF] = MACAddr[5];

  EPROM_General.E_Comm.E_MAC_Add[0] = MACAddr[0];
  EPROM_General.E_Comm.E_MAC_Add[1] = MACAddr[1];
  EPROM_General.E_Comm.E_MAC_Add[2] = MACAddr[2];
  EPROM_General.E_Comm.E_MAC_Add[3] = MACAddr[3];
  EPROM_General.E_Comm.E_MAC_Add[4] = MACAddr[4];
  EPROM_General.E_Comm.E_MAC_Add[5] = MACAddr[5];
...
/* USER CODE END ETH link Thread core code for User BSP */
    ...
    osDelay(500);  // TODO : change from 100 to 500 check effect
  }
}
