 ...
 * @{
 */
#define START_ADDRESS_PAGE_PROGRAM   	0x00000000
#define READ_ADDRESS                 	0x00000001
#define FLASH_END_ADRESS 			 	0x04000000

// ******************************** OTA FILE ***********************************************
//#define PUB_FILE_START_ADDRESS     		0x00001000
//#define PUB_FILE_END_ADDRESS       		0x00025FFF
//
//#define PUB_FILE_TOTAL_SEC				25
//
//#define COPY_PUB_FILE_START_ADDRESS     0x00026000
//#define COPY_PUB_FILE_END_ADDRESS       0x00050FFF
//
//#define REC_FILE_START_ADDRESS     		0x00051000
//#define REC_FILE_END_ADDRESS       		0x00055FFF
//
//#define COPY_REC_FILE_START_ADDRESS     0x00056000
//#define COPY_REC_FILE_END_ADDRESS       0x00060FFF
//
//#define REC_FILE_TOTAL_SEC				5
//
//#define HEX_FILE_START_ADDRESS     		0x00061000
//#define HEX_FILE_END_ADDRESS       		0x00572FFF
//
//#define BIN_FILE_TOTAL_SEC				512

#define CONFIG_FILE_START_ADDRESS			0x00000000 //1000
#define	CONFIG_FILE_END_ADDRESS				0x0006FFFF

#define CONFIG_FILE_TOTAL_SEC				112

#define EPROM_GENERAL_START_ADDRESS			0x00000000
#define	EPROM_GENERAL_END_ADDRESS			0x00001FFF

#define	EPROM_GENERAL_TOTAL_SEC				2

#define EPROM_SCHEDULE_START_ADDRESS		0x00002000
#define	EPROM_SCHEDULE_END_ADDRESS			0x00003FFF

#define	EPROM_SCHEDULE_TOTAL_SEC			2

#define EPROM_MODBUS_QUERY_DETAILS_START_ADDRESS		0x00004000
#define	EPROM_MODBUS_QUERY_DETAILS_END_ADDRESS			0x00005FFF

#define	EPROM_MODBUS_QUERY_DETAILS_TOTAL_SEC			2

#define EPROM_PCBPLC_GENERAL_REG_START_ADDRESS			0x00006000
#define	EPROM_PCBPLC_GENERAL_REG_END_ADDRESS			0x00007FFF

#define	EPROM_PCBPLC_GENERAL_REG_TOTAL_SEC				2

#define EPROM_REC_MODIFIED_START_ADDRESS				0x00008005	// change loction  it is temp loction
#define	EPROM_REC_MODIFIED_END_ADDRESS					0x00009FFF

#define	EPROM_REC_MODIFIED_TOTAL_SEC				2

#define EPROM_PERMENENT_DATA_START_ADDRESS				0x0000A000
#define	EPROM_PERMENENT_DATA_END_ADDRESS				0x0000AFFF

#define	EPROM_PERMENENT_DATA_TOTAL_SEC				1


#define OTA_UPDATE_DATA_START_ADDRESS		0x0000B000//4000 sector number for ota data storage
#define OTA_UPDATE_DATA_END_ADDRESS			0x0000BFFF

#define OTA_UPDATE_DATA_TOTAL_SEC			1

#define AI_CALIBRATION_DATA_START_ADDRESS		0x0000C000//4000 sector number for ota data storage
#define AI_CALIBRATION_DATA_END_ADDRESS			0x0000CFFF

#define AI_CALIBRATION_DATA_TOTAL_SEC			1

#define EPROM_FREQUENT_DATA_START_ADDRESS		0x0000D000//4000 sector number for ota data storage
#define EPROM_FREQUENT_DATA_END_ADDRESS			0x0000DFFF

#define AI_CALIBRATION_DATA_TOTAL_SEC			1

#define LORA_PARA_START_ADDRESS					0x0000E000
#define LORA_PARA_END_ADDRESS					0x0000EFFF

#define LORA_PARA_TOTAL_SEC						1

#define PCB_REC_INFO_FILE_START_ADDRESS		0x00070000
#define	PCB_REC_INFO_FILE_END_ADDRESS		0x00070FFF

#define PCB_REC_INFO_FILE_TOTAL_SEC				1

#define CA_FILE_START_ADDRESS				0x00083000
#define CA_FILE_END_ADDRESS					0x00087FFF

#define CA_FILE_TOTAL_SEC					5

#define CLIENT_CER_FILE_START_ADDRESS		0x00088000
#define CLIENT_CER_FILE_END_ADDRESS			0x0008CFFF

#define CLIENT_CER_FILE_TOTAL_SEC			5

#define CLIENT_KEY_FILE_START_ADDRESS		0x0008D000
#define CLIENT_KEY_FILE_END_ADDRESS			0x00091FFF

#define CLIENT_KEY_FILE_TOTAL_SEC			5

#define PUB_FILE_START_ADDRESS				0x000AB000
#define PUB_FILE_END_ADDRESS				0x000C3FFF

#define PUB_FILE_TOTAL_SEC					25

#define COPY_PUB_FILE_START_ADDRESS			0x000AB000
#define COPY_PUB_FILE_END_ADDRESS			0x000C3FFF

#define REC_FILE_START_ADDRESS				0x000C4000
#define REC_FILE_END_ADDRESS				0x000C8FFF

#define COPY_REC_FILE_START_ADDRESS			0x000C9000
#define COPY_REC_FILE_END_ADDRESS			0x000CDFFF

#define REC_FILE_TOTAL_SEC					5

#define HEX_FILE_START_ADDRESS				0x000CE000
#define HEX_FILE_END_ADDRESS				0x002CEFFF

#define HEX_FILE_TOTAL_SEC					512

#define HISTORY_DATA_FILE_START_ADDRESS		0x002D0000  //0x9C4000
#define HISTORY_DATA_FILE_END_ADDRESS		0x00C93FFF

#define HISTORY_DATA_FILE_TOTAL_SEC			2500

#define HISTORY_DATA_RUN_TIME_PARA_START_ADDRESS	0x00C94000
#define HISTORY_DATA_RUN_TIME_PARA_END_ADDRESS		0x00C94FFF

#define HISTORY_DATA_RUN_TIME_PARA_TOTAL_SEC			1

// ******************************** OTA FILE ***********************************************


/* SECTORs Address */
#define SECTOR_ONE_START_ADDRESS     	0x00000000
#define SECTOR_ONE_LAST_ADDRSS       	0x00000FFF

#define SECTOR_TWO_START_ADDRESS     	0x00001000
#define SECTOR_TWO_LAST_ADDRESS      	0x00001FFF

#define SECTOR_THIRD_START_ADDRESS   	0x00002000
#define SECTOR_THIRD_LAST_ADDRESS    	0x00002FFF

#define SECTOR_FOURTH_START_ADDRESS  	0x00003000
#define SECTOR_FOURH_LAST_ADDRESS    	0x00003FFF


#define SECTOR_FIFTH_START_ADDRESS   	0x00004000
#define SECTOR_FIFTH_LAST_ADDRESS    	0x00004FFF

#define SECTOR_SIX_START_ADDRESS     	0x00005000
#define SECTOR_SIX_LAST_ADDRESS      	0x00005FFF


#define SECTOR_SEVEN_START_ADDRESS   	0x00006000
#define SECTOR_SEVEN_LAST_ADDRESS    	0x00006FFF

#define SECTOR_EIGHT_START_ADDRESS   	0x00007000
#define SECTOR_EIGHT_LAST_ADDRESS    	0x00007FFF

#define SECTOR_NINE_START_ADDRESS   	0x00008000
#define SECTOR_NINE_LAST_ADDRESS    	0x00008FFF

//#define EXT_FLASH_LOC_PCBPLC_MAIN	0x009000  	// change loction  it is temp loction
//#define EXT_FLASH_LOC_REC_MAIN		0x01A000	// change loction  it is temp loction
//#define EXT_FLASH_LOC_REC_MODIFIED	0x00B000	// change loction  it is temp loction
/**
...
/// Mem size in MB-bit
#define MEM_FLASH_SIZE 128U//64U 	// 64 MB-bit
...
/// Blocks count
#define BLOCK_COUNT (MEM_FLASH_SIZE * 2) // 128 blocks
/// Sector count
#define SECTOR_COUNT (BLOCK_COUNT * 16)  // 2048 sectors
/// Pages count
#define PAGE_COUNT (SECTOR_COUNT * 16)	 // 32768 pages
...
extern unsigned char flag_flashSaveRecipe,flag_flashUpdateEPROM_General,flag_flashUpdateEPROM_AI_Calibration,flag_flashUpdateEPROM_Schedule,flag_flashUpdateEPROM_Modbus_Quary_Detail,
flag_flashUpdateEPROM_Frequent,flag_flashUpdateEPROM_LORA;
extern unsigned int flag_flashSaveRecipe_WaitCounter,flag_flashUpdateEPROM_General_WaitCounter,flag_flashUpdateEPROM_AI_Calibration_WaitCounter,flag_flashUpdateEPROM_Schedule_WaitCounter,
	flag_flashUpdateEPROM_Modbus_Quary_Detail_WaitCounter,flag_flashUpdateEPROM_PCBPLC_GENERAL_REG_WaitCounter,flag_flashUpdateEPROM_Frequent_WaitCounter,flag_flashUpdateEPROM_LORA_WaitCounter;
...
W25Q_STATE W25Q_Erase_Write_One_Sector(u8_t *buf, u16_t len, u32_t pageShift); ///< Sector erase, save in flash
W25Q_STATE W25Q_Write_continous(u8_t *buf, u16_t len, u32_t pageShift );
/**
